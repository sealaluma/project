...
def app():
    ...
    # show_infra_button = st.button("Показать распределение инфраструктуры")
    # if show_infra_button:
    #     with open("components/infra.html", "r") as f:
    #         infra_html = f.read()
    #         components.html(infra_html, height=600)
    ...
    show_business_button = st.button("Показать распределение бизнеса")
    ...
    # show_edc_button = st.button("Показать распределение дохода")
    # if show_edc_button:
    #     with open("components/edc.html", "r") as f:
    #         map_html = f.read()
    #         components.html(map_html, height=600)

    # st.header("Экономика")
    # Кнопка для показа рекомендаций по окэд
    # show_oked_button = st.button("Показать рекомендации для бизнеса по ОКЭД")
    
    # if show_oked_button:
    #     with open("components/oked.html", "r") as f:
    #         map_html = f.read()
    #         components.html(map_html, height=600)
    ...
    # show_oked_recommend_button = st.button("Рекомендации по направлениям ОКЭД")
    # if show_oked_recommend_button:
    #    with open("components/oked_recommend.html", "r") as f:
    #        map_html = f.read()
    #        components.html(map_html, height=600)
    #         # Создаем и добавляем легенду
    #        legend_html = """
    ...
    # # Ввод количества домов во второй колонке
    # with col2:
    ...
    #     )
        ...
        #         font-size: 18px;
        #         font-weight: bold; /* Заголовки категорий жирным */
        ...
        #         padding-left: 0px;
        #         color: #183F71;
        #         border-bottom: 1px solid #E1E1E1; /* Линия под рекомендацией */
        #     }
        #     </style>
        #     """,
        #     unsafe_allow_html=True
        ...
        # # Определение категории плотности населения
        # density_category = ""
        # if population_density < 8500:
        #     density_category = "low_density"
        # elif 8500 <= population_density < 11500:
        #     density_category = "medium_density"
        # else:
        ...
        # # Открытие контейнера для рекомендаций
        # recommendations_html = "<div class='recommendations-container'>"

        # if density_category:
        #     for category, details in data['recommendations'].items():
        #         if density_category in details:
        #             # Открываем контейнер для категории
        #             recommendations_html += "<div class='recommendation-item'>"
        #             # Добавляем заголовок категории
        #             recommendations_html += f"<div class='recommendation-title'>{category}</div>"
        #             for item in details[density_category]:
        #                 # Добавляем текст рекомендации
        #                 recommendations_html += f"<div class='recommendation-value'>{item}</div>"
        #             # Закрываем контейнер для категории
        #             recommendations_html += "</div>"
        #         else:
        #             # Если данных нет, выводим ошибку
        #             recommendations_html += f"<div class='error'>Данные для категории '{density_category}' в разделе '{category}' отсутствуют.</div>"

        # # Закрытие контейнера для рекомендаций
        # recommendations_html += "</div>"


        # # Вывод всего HTML сразу
        # st.markdown(recommendations_html, unsafe_allow_html=True)


        # recommendations = generated_text["recommendations"]
        # for category, items in recommendations.items():
        #     st.markdown(f"#### {category.capitalize()}:")
        #     for item in items:
        #         st.write_stream(typewriter_effect(item))
